...
<head>
  ...
  <link rel="manifest" href="https://i.imgur.com/WDlhTAH.png">
  <link rel="shortcut icon" type="image/x-icon" href="https://i.imgur.com/WDlhTAH.png">
              ...
              <div class="main-menu d-none d-md-block">
                <nav>
                  <ul id="navigation">
                    ...
                    <li><a href="user/createposts.jsp">Create Posts</a> </li>
                  </ul>
                </nav>
              </div>
            </div>
