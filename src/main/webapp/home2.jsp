...
<head>
    ...
    <link rel="manifest" href="https://i.imgur.com/FTCkxgI.png">
    <link rel="shortcut icon" type="image/x-icon" href="https://i.imgur.com/FTCkxgI.png">
                        ...
                        <div class="row d-flex justify-content-between align-items-center">
                            ...
                            <div class="header-info-right">
                                <ul class="header-social">
                                    ...
                                    <li class="menu">
                                        <img src="https://cdn-icons-png.flaticon.com/128/1077/1077114.png" width="10px" height="10px">


                                        <ul>
                                            <%--                                                                    <li><a href="/users?action=edit">Fix account</a></li>--%>
                ...
                <div class="container">
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3">
                            <div class="logo">
                                <a href="index.html"><img src="https://i.imgur.com/vktfXKe.png" alt="" width="200" height="100"></a>
                            </div>
                        </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-10 col-lg-10 col-md-12 header-flex">
                            ...
                            <div class="sticky-logo">
                                <a href="index.html"><img src="https://i.imgur.com/vktfXKe.png" alt="" width="100" height="50"></a>
                            </div>
                            <!-- Main-menu -->
...
<%--                                        <li><a href="contact.html">Contact</a></li>--%>
                                        ...
                                        <li><a href="posts/create.jsp">Create Posts</a> </li>
                                        <li><a href="posts?action=listPosts">Post you created</a> </li>
                    ...
                    <div class="single-footer-caption">
                        <div class="single-footer-caption">
                            ...
                            <div class="footer-logo">
                                <a href="index.html"><img src="https://i.imgur.com/vktfXKe.png" alt=""></a>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="footer-copy-right">
                            <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="ti-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">nguyenvanan</a>
